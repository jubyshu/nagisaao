...
字数统计参考自[Jekyll的中文字数统计](https://blog.fooleap.org/jekyll-count-of-chinese-characters.html)；豆瓣读书展示页来自[likebeta's Blog](https://github.com/likebeta/blog)，由于豆瓣API限制调用，改用[zce](https://github.com/zce)提供的接口地址；评论系统使用[Valine](https://valine.js.org/)和[ Valine Admin](https://panjunwen.com/valine-admin-document/)（用于邮件提醒）；其他的一些修改则得益于网络共享知识。
